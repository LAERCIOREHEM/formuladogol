  ...
  function renderManager() {
    ...
    root.innerHTML = `
      ...
      <section class="panel fdg-alert-panel"><div class="panel-inner">
        ...
        <label class="fdg-alert-switch"><span><strong>⚽ Gols</strong><small>Gol confirmado e aviso de gol anulado; autor, minuto e placar quando a fonte permite.</small></span><input type="checkbox" data-fdg-type="goals" ${p.goals ? 'checked' : ''}><i></i></label>
