...
METRIC_RULES = [
    {"keys": ["possession pct", "possession percent", "possession percentage", "possessionpct", "possession"], "label": "Posse", "order": 1, "percent": True},
    {"keys": ["total shots", "totalshots", "shots total", "shots"], "label": "Finalizações", "order": 2},
    {"keys": ["shots on goal", "shots on target", "shotsongoal", "shotsontarget"], "label": "Chutes no gol", "order": 3},
    {"keys": ["blocked shots", "blockedshots"], "label": "Chutes bloqueados", "order": 4},
    {"keys": ["shot pct", "shot percent", "shot percentage", "shotpct", "shooting percentage"], "label": "Aproveitamento dos chutes", "order": 5, "percent01": True, "note": "chutes no gol ÷ finalizações"},
    {"keys": ["fouls committed", "foulscommitted", "fouls"], "label": "Faltas", "order": 6},
    {"keys": ["saves", "goalkeeper saves"], "label": "Defesas", "order": 7},
    {"keys": ["total passes", "totalpasses", "passes", "pass attempts", "passattempts"], "label": "Passes", "order": 8},
    {"keys": ["accurate passes", "accuratepasses", "completed passes"], "label": "Passes certos", "order": 9},
    ...
    {"keys": ["tackles won", "tackleswon", "successful tackles", "successfultackles", "tackles"], "label": "Desarmes", "order": 11},
    {"keys": ["interceptions", "interception"], "label": "Interceptações", "order": 12},
    {"keys": ["accurate crosses", "accuratecrosses", "crosses", "cross attempts", "crossattempts"], "label": "Cruzamentos", "order": 13},
